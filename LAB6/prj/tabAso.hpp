...
TabAsoEle<T_K, T_D> * Tab_Aso<T_K, T_D>::TakeKey(T_K inkey)
{
    ...
    else
    {
        ...
        {	
         i = i -> next;
         if(i->isend){ cout << "Klucz " << inkey << " nie istnieje." << endl; return i;}
        }
...
/*! \brief Metoda Change zmienia wartoœæ dane na indane w podanym kluczu inkey */
template<class T_K, class T_D>
...
/*! \brief Metoda Size, zwraca iloœæ elementów w tablicy. */
template<class T_K, class T_D>
